...
def construct_datasets(pair_path, embedding_path, seqlookup_path, train_prop=.9, val_prop=.05, test_prop = .05):
    dataset = get_parquet(pair_path, embedding_path, seqlookup_path)
